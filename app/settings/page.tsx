...
const MAIN_ITEMS = [
  ...
  },
  {
    href: '/cim',
    title: 'CIM',
    description: 'Companies with NDA received — upload financials and track LOI status.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const TOOL_ITEMS = [
  ...
  },
  {
    href: '/emails',
    title: 'Email List',
    description: 'Checkbox list of every company with a stored email address. Resets every 2 weeks.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Scrape Google Maps state by state to find every garage door company in the US.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
