-- Add Henry, remove Sunzim, Daniel and Ellison from the team
...
-- 2. Drop old columns
ALTER TABLE companies DROP COLUMN IF EXISTS calls_sunzim;
...
DELETE FROM team_members WHERE name IN ('Sunzim', 'Daniel', 'Ellison');
